...
const Hero = () => {
  ...
  return (
    <div className=" h-fit pb-[25vh] sm:pb-5 w-full pt-7 px-[5vw] lg:px-[10vw] font-[bolld]">
      ...
      <div className={`h-fit rounded-2xl w-1/2 absolute top-0 right-0 bg-zinc-100 shadow-2xl z-[999] flex flex-col gap-10 items-start px-5 py-10 text-xl transform ${open ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-500`}>
